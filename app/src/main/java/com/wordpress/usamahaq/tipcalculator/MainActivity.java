package com.wordpress.usamahaq.tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    float percentage = 0f;
    float tipTotal = 0f;
    float finalBillAmount = 0f;
    float totalBillAmount = 0f;


    final float REGULAR_TIP_PERCENTAGE = 10f;
    final float DEFAULT_TIP_PERCENTAGE = 15f;
    final float EXCELLENT_TIP_PERCENTAGE = 20f;
